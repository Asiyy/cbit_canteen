    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">CBIT</span> <span class="clr-green">Canteen</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">CBIT</span> <span class="clr-green md">Canteen</span></div>
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>Chaitanya Bharathi Institute of Technology,Hyderabad , is a prestigious institute established in the year 1979has been approved by AICTE.
                        The institute holds reputable status among many popular ranking agencies. It offers B.E/B.Tech at the UG level and ME, M.Tech, MBA, MCA at the PG level.
                         The institute has maintained a positive placement rate in the four decades of its successful journey</p>
                        <ul class="py-1">
                            <li><i class="fab fa-facebook-f"></i><a href="https://www.facebook.com/CBIThyderabad" target="_blank"> Facebook</a></li>
                            <li><i class="fab fa-instagram"></i><a href="https://www.instagram.com/cbithyderabad/" target="_blank">Instagram</a></li>
                        </ul>
                    </article>
                    <!-- Navigation Links -->
                    ...
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>+91-040-24193276</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>principal@cbit.ac.in</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Chaitanya Bharathi Institute of Technology, Gandipet,Hyderabad, T.S, India, PIN: 500075</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>For Professional Courses, Visit: www.cbit.ac.in</p></li>
                        </ul>
                    </article>
                </main>
                <!-- Deep Devs Info -->
                <main class="deep-devs flex">
                    ...
                    <div class="">Designed & Developed with <i class="fas fa-heart clr-red"></i> By <a href="#">Shine</a></div>
                </main>
            </section>
        `;
        })
